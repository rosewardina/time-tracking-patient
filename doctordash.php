...
<body>
    <header>
        ...
        <div>
            ...
            if (isset($_SESSION['doctor_name'])) {
                echo "Doctor Name: " . htmlspecialchars($_SESSION['doctor_name']) . " - Role: " . htmlspecialchars($_SESSION['doctor_role']) . " - Shift: " . htmlspecialchars($_SESSION['doctor_shift']) . " - WardID: " . htmlspecialchars($_SESSION['doctor_ward']);
            } else {
    ...
    <nav>
        <a href="doctordash.php">Home</a>
        <a href="patientstatusdoc.php">Patient Queue</a>
